...
class TestIntegration:
    ...
    def test_complete_story_workflow(self, client):
        ...
        assert updated_story["author"] == story_data["author"]  # Should remain unchanged
    ...
    def test_multiple_stories_with_filtering(self, client):
        ...
        combined_response = client.get("/api/v1/stories/?genre=Fantasy&published_only=true")
    ...
    def test_error_handling_workflow(self, client):
        ...
        update_response = client.put(f"/api/v1/stories/{non_existent_id}", json=update_data)
        ...
        unpublish_response = client.patch(f"/api/v1/stories/{non_existent_id}/unpublish")
