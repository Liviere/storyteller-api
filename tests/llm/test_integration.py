...
class TestLLMImprovementIntegration:
    ...
    @pytest.mark.llm_integration
    @pytest.mark.slow
    def test_improve_with_testing_models(self, client: TestClient, integration_test_models, sample_story_content, skip_integration_tests):
...
class TestLLMEndToEndWorkflows:
    ...
    @pytest.mark.llm_integration
    @pytest.mark.slow
    def test_full_story_workflow(self, client: TestClient, integration_test_models, skip_integration_tests):
