...
Tests for Stories API endpoints that return TaskResponse objects.
These tests focus on verifying that tasks are properly submitted and 
can be monitored through the Task API.
TaskResponse objects are mocked to simulate async behavior.
"""
...
class TestStoryModel:
    ...
    def test_story_repr(self, db_session):
        ...
        story = Story(title="Test Story", content="Test content", author="Test Author")
        ...
        expected_repr = (
            f"<Story(id={story.id}, title='Test Story', author='Test Author')>"
        )
    ...
    def test_story_required_fields(self, db_session):
        ...
        # Test missing title
        story = Story(content="Test content", author="Test Author")
        db_session.add(story)
        ...
        story = Story(title="Test Title", author="Test Author")
        db_session.add(story)
        ...
        # Test missing author
        story = Story(title="Test Title", content="Test content")
        db_session.add(story)
