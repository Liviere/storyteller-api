        ...
        **kwargs,
        ...
        try:
            ...
            if improvement_type == "grammar":
                ...
                improved = await chain.improve_story(
                    content, focus_area, target_audience
                )
    ...
    async def translate_story(
        ...
        **kwargs,
        ...
        try:
            ...
            preserve_text = (
                "maintain original tone and style" if preserve_style else "adapt freely"
            )

            translated = await chain.translate_story(
                content, target_language, preserve_text
            )
